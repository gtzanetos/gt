...
def directions():
    global direc1,direc2,direc3,direc4,direc5,direc6,direc7
    ...
    direc4=canvas.create_text(600,290, text="Gold coins can be collected that can be used to buy different goods at the stores",font=('Helvetica',15))
    ...
    direc7=canvas.create_text(600,380, text="To start the game press the space bar",font=('Helvetica',15))
